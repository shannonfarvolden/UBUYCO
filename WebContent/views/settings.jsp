...
<%
		...
		try {
			...
			boolean passwordMatch = password != null && !password.equals("") && password2 != null && !password2.equals("") && password.equals(password2);
			...
			if (!hasPassword2)
				out.println("<div class=\"alert alert-danger\" role=\"alert\">Missing password confirmation!</div>");
			if (!passwordMatch)
				out.println("<div class=\"alert alert-danger\" role=\"alert\">Your password confirmation is incorrect!</div>");
			out.println("</div>");
...
<button type="submit" class="btn btn-danger delete-button">Delete Account</button>
</form>
